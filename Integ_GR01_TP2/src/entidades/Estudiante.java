...
public class Estudiante {
	...
	public Estudiante(int legajo, String nombre, String apellido, int edad, String genero, int dni,
			String ciudad_residencia, List<Guarani> carreras) {
		super();
		this.legajo = legajo;
		this.nombre = nombre;
	...
	public List<Guarani> getCarreras() {
		return carreras;
	}

	public void setCarreras(List<Guarani> carreras) {
